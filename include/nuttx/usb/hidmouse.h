...
#ifndef __INCLUDE_NUTTX_USB_MOUSE_H
#define __INCLUDE_NUTTX_USB_MOUSE_H
...
#define USBMOUSE_NUM_EPS             (1)

#define USBMOUSE_EP_INTIN_IDX        (0)

/* Endpoint configuration ***************************************************/

#define HIDMOUSE_MKEPINTIN(desc)    (USB_DIR_IN | (desc)->epno[USBMOUSE_EP_INTIN_IDX])
#define HIDMOUSE_EPINTIN_ATTR       (USB_EP_ATTR_XFER_INT)


/**************************************************************************/

struct usbmouse_report_s
{
  ...
  uint8_t wheel;    /* Mouse wheel position */
};
...
#endif /* __INCLUDE_NUTTX_USB_HIDMOUSE_H */
